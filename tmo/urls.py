...
from .views import (
    ...
    TMOFeederCouplingDetailView,
    TMOFeederCouplingView,
    TMOFeederDetailView,
...
urlpatterns = [
    ...
    path('settings/feeder-coupling/', TMOFeederCouplingView.as_view(),      name='settings-feeder-coupling'),
    path('settings/feeder-coupling/<uuid:event_id>/', TMOFeederCouplingDetailView.as_view(), name='settings-feeder-coupling-detail'),
    path('settings/outliers/',        TMOOutlierView.as_view(),             name='settings-outliers'),
    path('settings/outliers/<int:flag_id>/', TMOOutlierDetailView.as_view(), name='settings-outliers-detail'),
    path('settings/negative-net/',    TMONegativeNetView.as_view(),         name='settings-negative-net'),
    path('settings/negative-net/<int:flag_id>/', TMONegativeNetDetailView.as_view(), name='settings-negative-net-detail'),
