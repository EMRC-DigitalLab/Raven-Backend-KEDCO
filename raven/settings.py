...
# User-uploaded media (profile pictures, etc.)
# Served by nginx in staging/prod (see nginx/*.conf `location /media/`),
# by Django itself in local dev (see raven/urls.py DEBUG block).
MEDIA_URL = 'media/'
