...
class DailyTechnicalCalculator:
    ...
    def calculate_interruption_metrics(self):
        """Calculate interruption-related metrics for the day"""
        interruptions = FeederInterruption.objects.filter(
            feeder__in=self.feeders,
            occurred_at__date=self.target_date
        )
        ...
        return {
            ...
            'avg_turnaround_time': avg_duration,  # Same as duration for single day
            'avg_fault_turnaround_time': avg_fault_turnaround,
